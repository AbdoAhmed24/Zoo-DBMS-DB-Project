...
VALUES 
    ...
    (86, 'Zone B', '2024-08-26', 180),
    (105, 'Zone E', '2024-08-27', 60),
    (118, 'Zone A', '2024-08-28', 150),
    (138, 'Zone C', '2024-08-29', 30),
    (65, 'Zone D', '2024-08-30', 100),
    (81, 'Zone B', '2024-08-31', 45),
    (97, 'Zone E', '2024-09-01', 85),
    (112, 'Zone A', '2024-09-02', 40),
    (127, 'Zone C', '2024-09-03', 110),
    (60, 'Zone D', '2024-09-04', 70),
    (84, 'Zone B', '2024-09-05', 150),
    (96, 'Zone E', '2024-09-06', 20),
    (109, 'Zone A', '2024-09-07', 180),
    (132, 'Zone C', '2024-09-08', 55),
    (68, 'Zone D', '2024-09-09', 95),
    (83, 'Zone B', '2024-09-10', 35),
    (95, 'Zone E', '2024-09-11', 100),
    (110, 'Zone A', '2024-09-12', 120),
    (125, 'Zone C', '2024-09-13', 65),
    (70, 'Zone D', '2024-09-14', 150),
    (92, 'Zone B', '2024-09-15', 40),
    (100, 'Zone E', '2024-09-16', 90),
    (117, 'Zone A', '2024-09-17', 30),
    (137, 'Zone C', '2024-09-18', 200),
    (71, 'Zone D', '2024-09-19', 55),
    (93, 'Zone B', '2024-09-20', 80),
    (101, 'Zone E', '2024-09-21', 110),
    (123, 'Zone A', '2024-09-22', 20),
    (140, 'Zone C', '2024-09-23', 90),
    (72, 'Zone D', '2024-09-24', 180),
    (94, 'Zone B', '2024-09-25', 25),
    (106, 'Zone E', '2024-09-26', 150),
    (120, 'Zone A', '2024-09-27', 40),
    (141, 'Zone C', '2024-09-28', 70),
    (73, 'Zone D', '2024-09-29', 110),
    (134, 'Zone B', '2024-09-30', 30),
    (144, 'Zone E', '2024-10-01', 180),
    (163, 'Zone A', '2024-10-02', 55),
    (147, 'Zone C', '2024-10-03', 150),
    (75, 'Zone D', '2024-10-04', 20),
    (150, 'Zone B', '2024-10-05', 90),
    (158, 'Zone E', '2024-10-06', 40),
    (170, 'Zone A', '2024-10-07', 70),
    (171, 'Zone C', '2024-10-08', 120),
    (76, 'Zone D', '2024-10-09', 25),
    (78, 'Zone B', '2024-10-10', 200),
    (99, 'Zone E', '2024-10-11', 55),
    (113, 'Zone A', '2024-10-12', 130),
    (129, 'Zone C', '2024-10-13', 35),
    (62, 'Zone D', '2024-10-14', 160),
    (85, 'Zone B', '2024-10-15', 75),
    (103, 'Zone E', '2024-10-16', 105),
    (119, 'Zone A', '2024-10-17', 10),
    (124, 'Zone C', '2024-10-18', 145),
    (67, 'Zone D', '2024-10-19', 50),
    (91, 'Zone B', '2024-10-20', 120),
    (107, 'Zone E', '2024-10-21', 85),
    (122, 'Zone A', '2024-10-22', 170),
    (136, 'Zone C', '2024-10-23', 15),
    (63, 'Zone D', '2024-10-24', 130),
    (90, 'Zone B', '2024-10-25', 95),
    (104, 'Zone E', '2024-10-26', 65),
    (111, 'Zone A', '2024-10-27', 25),
    (126, 'Zone C', '2024-10-28', 140),
    (66, 'Zone D', '2024-10-29', 80),
    (88, 'Zone B', '2024-10-30', 155),
    (102, 'Zone E', '2024-10-31', 45),
    (116, 'Zone A', '2024-11-01', 105),
    (130, 'Zone C', '2024-11-02', 20),
    (61, 'Zone D', '2024-11-03', 110),
    (89, 'Zone B', '2024-11-04', 25),
    (120, 'Zone E', '2024-11-05', 150),
    (114, 'Zone A', '2024-11-06', 40),
    (128, 'Zone C', '2024-11-07', 70),
    (69, 'Zone D', '2024-11-08', 90),
    (87, 'Zone B', '2024-11-09', 180),
    (95, 'Zone E', '2024-11-10', 30),
    (110, 'Zone A', '2024-11-11', 110),
    (135, 'Zone C', '2024-11-12', 50),
    (64, 'Zone D', '2024-11-13', 130),
    (81, 'Zone B', '2024-11-14', 75),
    (100, 'Zone E', '2024-11-15', 90),
    (113, 'Zone A', '2024-11-16', 25),
    (127, 'Zone C', '2024-11-17', 140),
    (70, 'Zone D', '2024-11-18', 80);
