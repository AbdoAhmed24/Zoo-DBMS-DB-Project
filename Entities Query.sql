...
create table Staff(
    ...
    (NULL, 7, NULL, Null, '8449733147', 'Youssef', NULL, 'Mohammed', '456 Elm St', 'yousef@example.com', 8000, 'M', 'Clinic Manager', '2019-07-20', '1988-09-20', '10:00 AM - 6:00 PM'),
    (NULL, 8, NULL, Null, '6234433129', 'Youssef', NULL, 'Mohammed', '456 Elm St', 'yousef@example.com', 8000, 'M', 'Clinic Manager', '2019-07-20', '1988-09-20', '10:00 AM - 6:00 PM'),
...
VALUES 
    (23, 'Zone C', '2024-04-01', 50),
    (97, 'Zone E', '2024-04-15', 100),
    (55, 'Zone D', '2024-04-16', 30),
    (134, 'Zone B', '2024-04-17', 200),
    (45, 'Zone A', '2024-04-18', 20),
    (176, 'Zone C', '2024-04-19', 150),
    (82, 'Zone A', '2024-04-20', 10),
    (108, 'Zone B', '2024-04-21', 80),
    (13, 'Zone D', '2024-04-22', 40),
    (4, 'Zone E', '2024-04-23', 250),
    (182, 'Zone A', '2024-04-24', 35),
    (51, 'Zone C', '2024-04-25', 300),
    (141, 'Zone B', '2024-04-26', 25),
    (73, 'Zone E', '2024-04-27', 200),
    (97, 'Zone A', '2024-04-28', 15),
    (118, 'Zone C', '2024-04-29', 90),
    (157, 'Zone D', '2024-04-30', 45),
    (22, 'Zone B', '2024-05-01', 270),
    (9, 'Zone E', '2024-05-02', 60),
    (187, 'Zone A', '2024-05-03', 70),
    (135, 'Zone C', '2024-05-04', 25),
    (105, 'Zone D', '2024-05-05', 80),
    (164, 'Zone E', '2024-05-06', 40),
    (176, 'Zone A', '2024-05-07', 230),
    (32, 'Zone C', '2024-05-08', 55),
    (115, 'Zone B', '2024-05-09', 300),
    (83, 'Zone D', '2024-05-10', 20),
    (157, 'Zone E', '2024-05-11', 95),
    (199, 'Zone A', '2024-05-12', 45),
    (114, 'Zone C', '2024-05-13', 260),
    (77, 'Zone D', '2024-05-14', 65),
    (56, 'Zone E', '2024-05-15', 70),
    (121, 'Zone A', '2024-05-16', 30),
    (168, 'Zone B', '2024-05-17', 100),
    (192, 'Zone C', '2024-05-18', 50),
    (15, 'Zone D', '2024-05-19', 280),
    (43, 'Zone E', '2024-05-20', 75),
    (134, 'Zone A', '2024-05-21', 110),
    (190, 'Zone C', '2024-05-22', 15),
    (195, 'Zone D', '2024-05-23', 85),
    (50, 'Zone E', '2024-05-24', 60),
    (101, 'Zone A', '2024-05-25', 320),
    (65, 'Zone C', '2024-05-26', 65),
    (127, 'Zone D', '2024-05-27', 75),
    (163, 'Zone E', '2024-05-28', 25),
    (197, 'Zone A', '2024-05-29', 90),
    (113, 'Zone C', '2024-05-30', 45),
    (94, 'Zone D', '2024-05-31', 280),
    (71, 'Zone E', '2024-06-01', 70),
    (41, 'Zone A', '2024-06-02', 110),
    (166, 'Zone C', '2024-06-03', 20),
    (189, 'Zone D', '2024-06-04', 95),
    (96, 'Zone E', '2024-06-05', 50),
    (158, 'Zone A', '2024-06-06', 300),
    (99, 'Zone C', '2024-06-07', 55),
    (124, 'Zone D', '2024-06-08', 80),
    (16, 'Zone E', '2024-06-09', 10),
    (74, 'Zone A', '2024-06-10', 120),
    (147, 'Zone C', '2024-06-11', 70),
    (6, 'Zone D', '2024-06-12', 330),
    (124, 'Zone E', '2024-06-13', 60),
    (82, 'Zone A', '2024-06-14', 110),
    (106, 'Zone C', '2024-06-15', 15),
    (122, 'Zone D', '2024-06-16', 85),
    (67, 'Zone E', '2024-06-17', 40),
    (82, 'Zone A', '2024-06-18', 360),
    (179, 'Zone C', '2024-06-19', 95),
    (100, 'Zone D', '2024-06-20', 55),
    (187, 'Zone E', '2024-06-21', 25),
    (199, 'Zone A', '2024-06-22', 100),
    (131, 'Zone C', '2024-06-23', 50),
    (184, 'Zone D', '2024-06-24', 280),
    (40, 'Zone E', '2024-06-25', 75),
    (169, 'Zone A', '2024-06-26', 130),
    (160, 'Zone C', '2024-06-27', 20),
    (135, 'Zone D', '2024-06-28', 105),
    (195, 'Zone E', '2024-06-29', 65),
    (172, 'Zone A', '2024-06-30', 310),
    (139, 'Zone C', '2024-07-01'),
    (83, 'Zone B', '2024-07-02', 45),
    (56, 'Zone E', '2024-07-03', 80),
    (117, 'Zone A', '2024-07-04', 100),
    (99, 'Zone C', '2024-07-05', 25),
    (77, 'Zone D', '2024-07-06', 60),
    (112, 'Zone B', '2024-07-07', 110),
    (88, 'Zone E', '2024-07-08', 70),
    (121, 'Zone A', '2024-07-09', 40),
    (135, 'Zone C', '2024-07-10', 95),
    (67, 'Zone D', '2024-07-11', 120),
    (143, 'Zone B', '2024-07-12', 30),
    (155, 'Zone E', '2024-07-13', 150),
    (90, 'Zone A', '2024-07-14', 20),
    (177, 'Zone C', '2024-07-15', 200),
    (106, 'Zone D', '2024-07-16', 55),
    (124, 'Zone B', '2024-07-17', 80),
    (78, 'Zone E', '2024-07-18', 65),
    (111, 'Zone A', '2024-07-19', 30),
    (137, 'Zone C', '2024-07-20', 100),
    (62, 'Zone D', '2024-07-21', 35),
    (85, 'Zone B', '2024-07-22', 180),
    (119, 'Zone E', '2024-07-23', 40),
    (142, 'Zone A', '2024-07-24', 75),
    (91, 'Zone C', '2024-07-25', 90),
    (178, 'Zone D', '2024-07-26', 25),
    (103, 'Zone B', '2024-07-27', 220),
    (132, 'Zone E', '2024-07-28', 55),
    (155, 'Zone A', '2024-07-29', 150),
    (81, 'Zone C', '2024-07-30', 70),
    (113, 'Zone D', '2024-07-31', 45),
    (127, 'Zone B', '2024-08-01', 80),
    (75, 'Zone E', '2024-08-02', 110),
    (109, 'Zone A', '2024-08-03', 30),
    (129, 'Zone C', '2024-08-04', 85),
    (59, 'Zone D', '2024-08-05', 40),
    (88, 'Zone B', '2024-08-06', 200),
    (102, 'Zone E', '2024-08-07', 60),
    (116, 'Zone A', '2024-08-08', 150),
    (148, 'Zone C', '2024-08-09', 25),
    (63, 'Zone D', '2024-08-10', 95),
    (86, 'Zone B', '2024-08-11', 50),
    (107, 'Zone E', '2024-08-12', 80),
    (122, 'Zone A', '2024-08-13', 40),
    (138, 'Zone C', '2024-08-14', 110),
    (60, 'Zone D', '2024-08-15', 75),
    (89, 'Zone B', '2024-08-16', 30),
    (104, 'Zone E', '2024-08-17', 150),
    (118, 'Zone A', '2024-08-18', 20),
    (136, 'Zone C', '2024-08-19', 180),
    (66, 'Zone D', '2024-08-20', 65),
    (79, 'Zone B', '2024-08-21', 90),
    (98, 'Zone E', '2024-08-22', 40),
    (115, 'Zone A', '2024-08-23', 70),
    (131, 'Zone C', '2024-08-24', 120),
    (64, 'Zone D', '2024-08-25', 25),
    (87, 'Zone B', '2024-08-26', 180),
    (105, 'Zone E', '2024-08-27', 60),
    (120, 'Zone A', '2024-08-28', 150),
    (140, 'Zone C', '2024-08-29', 30),
    (65, 'Zone D', '2024-08-30', 100),
    (82, 'Zone B', '2024-08-31', 45),
    (97, 'Zone E', '2024-09-01', 85),
    (114, 'Zone A', '2024-09-02', 40),
    (128, 'Zone C', '2024-09-03', 110),
    (61, 'Zone D', '2024-09-04', 70),
    (80, 'Zone B', '2024-09-05', 150),
    (96, 'Zone E', '2024-09-06', 20),
    (110, 'Zone A', '2024-09-07', 180),
    (133, 'Zone C', '2024-09-08', 55),
    (68, 'Zone D', '2024-09-09', 95),
    (84, 'Zone B', '2024-09-10', 35),
    (95, 'Zone E', '2024-09-11', 100),
    (108, 'Zone A', '2024-09-12', 120),
    (123, 'Zone C', '2024-09-13', 65),
    (69, 'Zone D', '2024-09-14', 150),
    (92, 'Zone B', '2024-09-15', 40),
    (100, 'Zone E', '2024-09-16', 90),
    (125, 'Zone A', '2024-09-17', 30),
    (139, 'Zone C', '2024-09-18', 200),
    (70, 'Zone D', '2024-09-19', 55),
    (93, 'Zone B', '2024-09-20', 80),
    (101, 'Zone E', '2024-09-21', 110),
    (126, 'Zone A', '2024-09-22', 20),
    (141, 'Zone C', '2024-09-23', 90),
    (71, 'Zone D', '2024-09-24', 180),
    (94, 'Zone B', '2024-09-25', 25),
    (106, 'Zone E', '2024-09-26', 150),
    (130, 'Zone A', '2024-09-27', 40),
    (144, 'Zone C', '2024-09-28', 70),
    (72, 'Zone D', '2024-09-29', 110),
    (135, 'Zone B', '2024-09-30', 30),
    (145, 'Zone E', '2024-10-01', 180),
    (163, 'Zone A', '2024-10-02', 55),
    (147, 'Zone C', '2024-10-03', 150),
    (74, 'Zone D', '2024-10-04', 20),
    (150, 'Zone B', '2024-10-05', 90),
    (159, 'Zone E', '2024-10-06', 40),
    (171, 'Zone A', '2024-10-07', 70),
    (172, 'Zone C', '2024-10-08', 120),
    (77, 'Zone D', '2024-10-09', 25);
